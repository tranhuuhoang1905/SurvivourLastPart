...
namespace GameNatra.Editor
{
    ...
    {
        private const string UIPrefabFolder = "Assets/GameTemplate/Prefabs/UI";
        private const string UIIdScriptFolder = "Assets/GameTemplate/Scripts/Basic";
        private const string ScreenIdScriptName = "ScreenIds";
        private const string ScreenIdScriptNamespace = "GameTemplate";

        [MenuItem("Assets/GameTemplate/Re-generate UI ScreenIds")]
